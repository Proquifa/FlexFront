package vista.modelo
{
	...
	public class ModeloRealizarDailyScrum extends EventDispatcher
	{
		...
		///////////////////////////////////////////   INICIAR SCRUM Y OBTENER CODIGOS DE ASISTENCIA
		private var empleadosCodigos:ArrayCollection;
		public function setEmpleadosCodigos( value:ArrayCollection ):void{
			empleadosCodigos = new ArrayCollection;
			if(value){
				empleadosCodigos = value;
			}
			dispatchEvent( new Event("obtenerCodigosAsistenciaEVRealizarDailyScrum") );
		}
		[Bindable(event="obtenerCodigosAsistenciaEVRealizarDailyScrum")]
		public function get enviarEmpleadosCodigos():ArrayCollection{
			return empleadosCodigos;
		}
