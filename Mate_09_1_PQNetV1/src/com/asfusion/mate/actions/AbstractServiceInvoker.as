...
   		 * unregistered after the first inner handlers fires.
		...
		*                                         Public Setters and Getters
		...
		{
			/*Anular el id-FlexClient para que (BlazeDS-Quien crea la session en el runtime al invocar un RemotingService) 
			no detecte el mismo FlexClient al recrear nuevamanete la session (esto debido a que en un cierto tiempo la session se rompe pero sigue estando en BlazeDS)*/
