package vista.evento
{
	...
	public class EventoASReqMovil extends Event
	{
		...
		public function EventoASReqMovil(type:String, bubbles:Boolean=true, cancelable:Boolean=false)
		{
			super(type, bubbles, cancelable);
		}
		public override function clone():Event
		{
			return new EventoASReqMovil( type, bubbles, cancelable );
		}
	}
}