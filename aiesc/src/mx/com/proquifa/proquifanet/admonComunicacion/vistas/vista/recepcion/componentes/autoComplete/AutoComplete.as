package mx.com.proquifa.proquifanet.admonComunicacion.vistas.vista.recepcion.componentes.autoComplete
{
	...
	import mx.com.proquifa.proquifanet.admonComunicacion.vistas.vista.recepcion.componentes.autoComplete.AutoCompleteSkin;
	import mx.com.proquifa.proquifanet.admonComunicacion.vistas.vista.recepcion.componentes.autoComplete.event.CustomEvent;
	...
	public class AutoComplete extends SkinnableComponent
	{
		...
		public function set selectedItem(item:Object):void{// iba sin void
			_selectedItem = item;
		...
		private function onChange(event:TextOperationEvent):void{// iba sin void
			_text = inputTxt.text;
		...
		public function filterData():void{// iba sin void
		...
		{
			if (item == null) return _text; //"";
			
			if (labelFunction == true )
				return labelFunction(item);
			else if (labelField && item[labelField] || item )
		...
		private function onMouseOut(event:MouseEvent):void{// iba sin void
		...
		public function acceptCompletion() : void
		{
			if (list.selectedIndex >= 0 && collection.length>0)
			{
				...
				//----------------------PARA LANZAR EVENTO Q SELECCIONA EL EMPLEADO DE LA EMPRESA-------------------------------------------------------------------
