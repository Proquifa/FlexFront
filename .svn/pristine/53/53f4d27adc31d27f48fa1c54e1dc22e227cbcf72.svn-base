package vista.evento
{
	...
	public class EventoAEReqMovil extends Event
	{
		...
		public function EventoAEReqMovil(type:String, bubbles:Boolean=true, cancelable:Boolean=false)
		{
			super(type, bubbles, cancelable);
		}
		public override function clone():Event
		{
			return new EventoAEReqMovil( type, bubbles, cancelable );
		}
	}
}