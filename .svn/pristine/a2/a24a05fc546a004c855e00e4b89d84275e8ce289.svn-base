package mx.com.proquifa.proquifanet.rsl.vista.modelo.catalogos.proveedores
{
	...
	public class ClasificacionConfiguracionPrecio
	{
		...
		private var _confPrecioProducto:ConfiguracionPrecioProducto;
		...
		public function get confPrecioProducto():ConfiguracionPrecioProducto
		{
			return _confPrecioProducto;
		}

		public function set confPrecioProducto(value:ConfiguracionPrecioProducto):void
		{
			_confPrecioProducto = value;
		}
