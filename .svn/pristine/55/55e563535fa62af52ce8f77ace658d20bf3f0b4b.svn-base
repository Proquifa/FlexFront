package mx.com.proquifa.proquifanet.rsl.vista.vistas
{
	...
	import mx.com.proquifa.proquifanet.rsl.vista.vistas.compresorVentanas.CompresorPositionElements;
	...
	public class CompresorVentanas extends Group
	{
		...
		public function CompresorVentanas()
		{
			super();
			super.percentWidth = 100;
			super.percentHeight = 100;
			super.layout = new CompresorPositionElements();
		}
		...
		public function agregarComponentes( $componentes:ArrayCollection,$porcentajeCrecimiento:int=50):void
		{
			...
			(layout as CompresorPositionElements).factorCrecimiento = $porcentajeCrecimiento;
		...
		protected function resizeIn(currentGroup:IVisualElement):void
		{
			...
			maxi.widthTo = (currentGroup.getLayoutBoundsWidth()+ currentGroup.getLayoutBoundsWidth() * (layout as CompresorPositionElements).factorCrecimiento);
		...
		protected function resizeOut(currentGroup:IVisualElement):void
		{
			...
			maxi.startDelay = 0;
			maxi.widthFrom =  currentGroup.getLayoutBoundsWidth();
			maxi.widthTo = (layout as CompresorPositionElements).panelWidth;
			//maxi.suspendBackgroundProcessing = true;
			maxi.addEventListener(EffectEvent.EFFECT_END,resizeEndHandler,false,0,true);
			maxi.play();
