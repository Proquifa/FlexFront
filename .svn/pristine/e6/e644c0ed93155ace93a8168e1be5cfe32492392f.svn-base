package mx.com.proquifa.vista.modelo.monitorearNacionales
{
	...
	public class ModeloMonitorearNacionales extends EventDispatcher
	{
		...
		{   
			if(data == null)
				...
				resumenOC = data;setObtenerHistorial
		...
		public function setObtenerPartidasRC(value:ArrayCollection):void
		{
			if(value == null){
				...
				for (var i2:int = 0; i2 < value.length; i2++) 
				{
					...
					value[i2].fechaAlmacenRespaldo = value[i2].fechaAlmacen;
				}
		...
		public function setObtenerHistorial(phistorial:ArrayCollection, event:EventoMonitorearNacionales):void
		{
		...
		public function ModeloMonitorearNacionales()
		{
