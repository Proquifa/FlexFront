package mx.com.proquifa.proquifanet.rsl.vista.modelo.comun
{
	...
	public class DocumentoOrdenDespacho
	{
		...
		private var _monedaOC:String;
		private var _noFactura:String;
		private var _documentos:ArrayCollection;
		
		private var _montoFacturaF:Number;
		private var _idProveedor:int;
		private var _proveedorFacturaF:String;
		...
		public function get proveedorFacturaF():String
		{
			return _proveedorFacturaF;
		}

		public function set proveedorFacturaF(value:String):void
		{
			_proveedorFacturaF = value;
		}
		...
		public function get montoFacturaF():Number
		{
			return _montoFacturaF;
		}

		public function set montoFacturaF(value:Number):void
		{
			_montoFacturaF = value;
		}
		...
		public function get monedaOC():String
		{
			return _monedaOC;
		}

		public function set monedaOC(value:String):void
		{
			_monedaOC = value;
		}

		public function get autorizado():Boolean
		{
			return _autorizado;
		}

		public function set autorizado(value:Boolean):void
		{
			_autorizado = value;
		}
