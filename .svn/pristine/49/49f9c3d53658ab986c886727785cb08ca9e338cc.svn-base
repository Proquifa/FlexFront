package vista.modelo
{
	...
	public class ModeloEVPlanificarSprint extends EventDispatcher
	{
		...
		/**
		 ***************************************************** TODOS SPRINTS SIN CERRAR  *************************************************************
		 */
		
		private var listaSprintsSinCerrar:ArrayCollection;
		public function setObtenerSprinSinCerrar( data:ArrayCollection ):void{
			if( data == null ){
				listaSprintsSinCerrar = new ArrayCollection();
				
				
			}else{
				listaSprintsSinCerrar = data;
			}
			
			dispatchEvent( new Event("obtenerlistaSprintsSinCerrar") );
		}
		[Bindable(event="obtenerlistaSprintsSinCerrar")]
		public function get enviarSprintsSinCerrar():ArrayCollection{
			return listaSprintsSinCerrar;
		}
