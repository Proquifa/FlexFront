package mx.com.proquifa.proquifanet.rsl.vista.modelo.compras
{
	...
	public class OrdenDespacho
	{
		...
		private var _compradorDestinatario:Empleado;
		private var _fpedimento:Date;
		
		private var _listaShipper:ArrayCollection; 
		...
		private var _codigoGSeguridad:int;
		private var _codigoComprador:int;
		...
		public function get listaShipper():ArrayCollection
		{
			return _listaShipper;
		}

		public function set listaShipper(value:ArrayCollection):void
		{
			_listaShipper = value;
		}
		...
		public function get codigoComprador():int
		{
			return _codigoComprador;
		}

		public function set codigoComprador(value:int):void
		{
			_codigoComprador = value;
		}

		public function get codigoGSeguridad():int
		{
			return _codigoGSeguridad;
		}

		public function set codigoGSeguridad(value:int):void
		{
			_codigoGSeguridad = value;
		}

		public function get compradorDestinatario():Empleado
		{
			return _compradorDestinatario;
		}

		public function set compradorDestinatario(value:Empleado):void
		{
			_compradorDestinatario = value;
		}

		public function get fpedimento():Date
		{
			return _fpedimento;
		}

		public function set fpedimento(value:Date):void
		{
			_fpedimento = value;
		}
