package vista.evento
{
	...
	public class EventoAEGestionarVisitas extends Event
	{
		...
		public function EventoAEGestionarVisitas(type:String, bubbles:Boolean=true, cancelable:Boolean=false)
		{
			super(type, bubbles, cancelable);
		}
		
		public override function clone():Event{
			return new EventoAEGestionarVisitas( type, bubbles, cancelable );
		}
	}
}