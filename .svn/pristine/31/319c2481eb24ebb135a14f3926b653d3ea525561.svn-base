package mx.com.proquifa.vista.modelo.tramitarCompra
{
	...
	public class ModeloTramitarCompraPublicaciones extends EventDispatcher
	{
		...
		private var arrayListaPedidosNacional:ArrayCollection;
		...
		public function setObtenerPedidosNacional(data:ArrayCollection):void
		{
			var fila:int = 1;
			if(data == null || data.length == 0)
				arrayListaPedidosNacional = new ArrayCollection();
			else
				arrayListaPedidosNacional = data;
			...
			dispatchEvent(new Event("enviarListaPedidosModeloTramitarCompraPubNacional"));
			dispatchEvent(new Event("enviarListaProveedoresPieTramitarCompraPubNacional"));
			dispatchEvent(new Event("enviarListaTransitoPieTramitarCompraPubNacional"));
			dispatchEvent(new Event("enviarListaFamiliaPieTramitarCompraPubNacional"));
		}
		
		[Bindable(event="enviarListaPedidosModeloTramitarCompraPubNacional")]
		public function get enviarListaPedidosNacional():ArrayCollection
		{
			return ordenesCompraPendientesNacional;
		}
		[Bindable(event="enviarListaProveedoresPieTramitarCompraPubNacional")]
		public function get enviarListaProveedoresPieNacional():ArrayCollection
		{
			return arrayProveedoresPieNacional;
		}
		[Bindable(event="enviarListaTransitoPieTramitarCompraPubNacional")]
		public function get enviarListaTransitoPieNacional():ArrayCollection
		{
			return arrayTransitoPieNacional;
		}
		[Bindable(event="enviarListaFamiliaPieTramitarCompraPubNacional")]
		...
		public function setObtenerFamiliasProveeNacional($universo:ArrayCollection):void{
			...
			_familiasProveeNacional = $universo;
			dispatchEvent(new Event ("familiasProveedorTramitarCompraPubNacional"));
		}
		
		[Bindable(event="familiasProveedorTramitarCompraPubNacional")]
