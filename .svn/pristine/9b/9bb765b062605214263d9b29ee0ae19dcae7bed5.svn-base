package mx.com.proquifa.proquifanet.rsl.vista.modelo.compras
{
	...
	public class RegistroConfirmacion extends PartidaCompra
	{
		...
		private var _alisasVendedor:String;
		...
		private var _indiceTabla:Number;
		...
		private var _fechaAlmacenRespaldo:Date;
		
		private var _backCancelar:Boolean;
		private var _backStockBO:Boolean;
		
		private var _totalPedidos:int;
		...
		public function get totalPedidos():int
		{
			return _totalPedidos;
		}

		public function set totalPedidos(value:int):void
		{
			_totalPedidos = value;
		}

	    public function get backStockBO():Boolean
		{
			return _backStockBO;
		}

		public function set backStockBO(value:Boolean):void
		{
			_backStockBO = value;
		}

		public function get backCancelar():Boolean
		{
			return _backCancelar;
		}

		public function set backCancelar(value:Boolean):void
		{
			_backCancelar = value;
		}

		public function get fechaAlmacenRespaldo():Date
		{
			return _fechaAlmacenRespaldo;
		}

		public function set fechaAlmacenRespaldo(value:Date):void
		{
			_fechaAlmacenRespaldo = value;
		}

		public function get indiceTabla():Number
		{
			return _indiceTabla;
		}

		public function set indiceTabla(value:Number):void
		{
			_indiceTabla = value;
		}
		...
		public function get diasFiltrados():String
		{
			...
			var fechaLejana:Date = fechaMonitoreo;
		...
		public function get alisasVendedor():String
		{
			return _alisasVendedor;
		}

		public function set alisasVendedor(value:String):void
		{
			_alisasVendedor = value;
		}
