package vista.modelo
{
	...
	public class ModeloJuntaCierreDeSprint extends EventDispatcher
	{
		...
		private var datosSeccionReporte:ReportarVisita;
		public function setObtenerDatosSeccionReporte(resp:ReportarVisita):void{
		...
		public function get enviarObtenerDatosSeccionReporte():ReportarVisita{
