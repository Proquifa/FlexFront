package mx.com.proquifa.proquifanet.rsl.vista.vistas.tableros.clientes.componentes
{
	...
	public class BarGreenRendererExpoMed extends UIComponent implements IDataRenderer
	{
		...
		public function BarGreenRendererExpoMed():void
		{
			super();
		}
		...
		override protected function updateDisplayList(unscaledWidth:Number,unscaledHeight:Number):void
		{
			...
			if( Number(csi.item[cs.yField]) == 0 || csi.item[cs.yField+"Label"] == null ){
				...
				label.x = int(unscaledWidth/2 - label.width/2);
