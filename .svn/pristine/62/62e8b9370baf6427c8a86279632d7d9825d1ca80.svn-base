package mx.com.proquifa.proquifanet.rsl.vista.modelo.comun
{
	...
	public class CarteraCliente extends Cliente
	{
		...
		private var _cart_idEVT:Number;
		...
		private var _cart_nombreEVT:String;
		...
		public function CarteraCliente()
		{
			...
			_cart_nombreEVT = "Sin Asignación"; 
		...
		public function get cart_nombreEVT():String
		{
			return _cart_nombreEVT;
		}

		public function set cart_nombreEVT(value:String):void
		{
			_cart_nombreEVT = value;
		}

		public function get cart_idEVT():Number
		{
			return _cart_idEVT;
		}

		public function set cart_idEVT(value:Number):void
		{
			_cart_idEVT = value;
		}

		public function get cli_idEVT():Number
		{
			return _cli_idEVT;
		}

		public function set cli_idEVT(value:Number):void
		{
			_cli_idEVT = value;
		}

		public function get idEVT():Number
		{
			return _idEVT;
		}

		public function set idEVT(value:Number):void
		{
			_idEVT = value;
		}
