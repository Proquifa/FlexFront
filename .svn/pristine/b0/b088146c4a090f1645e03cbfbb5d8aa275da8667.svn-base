package mx.com.proquifa.proquifanet.rsl.vista.modelo.comun
{
	...
	public dynamic class Empleado
	{
		...
		private var _asistencia:Boolean;
		
		private var _valor:String;
		private var _llave:Number;
		private var _codigoAsistencia:String;
		...
		public function get codigoAsistencia():String
		{
			return _codigoAsistencia;
		}

		public function set codigoAsistencia(value:String):void
		{
			_codigoAsistencia = value;
		}

		public function get asistencia():Boolean
		{
			return _asistencia;
		}

		public function set asistencia(value:Boolean):void
		{
			_asistencia = value;
		}
