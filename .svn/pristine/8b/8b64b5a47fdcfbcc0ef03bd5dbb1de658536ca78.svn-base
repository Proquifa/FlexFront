package mx.com.proquifa.proquifanet.admonComunicacion.vistas.modelo
{
	...
	public class ModeloPendientesPorEnviar extends EventDispatcher
	{
		...
		public function ModeloPendientesPorEnviar(target:IEventDispatcher=null)
		{
		...
		public function get cotizacionesPorEnviar():ArrayCollection{
			return this._correosCotizacion;
		}		
