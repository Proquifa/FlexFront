package mx.com.proquifa.proquifanet.rsl.vista.vistas.tableros.clientes.componentes.ventasDelPeriodo.analisisDeVentas.distribuidor
{
	...
	[Event(name="terminoDeAsignarTamaniosAlosComponentesLayoutDistribuidorEsac", type="flash.events.Event")]
	public class LayoutDistribuidorEsac extends LayoutBase
	{
		public function LayoutDistribuidorEsac()
		{
			super();
		}
		...
		override public function updateDisplayList($containerWidth:Number, $containerHeight:Number):void
		{
			...
			if($containerWidth > 300 )
			{
				...
				dispatchEvent(new Event("terminoDeAsignarTamaniosAlosComponentesLayoutDistribuidorEsac"));
			}
		}
	}
}