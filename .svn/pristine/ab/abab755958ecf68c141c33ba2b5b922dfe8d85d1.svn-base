package mx.com.proquifa.proquifanet.rsl.vista.eventos.catalogos.proveedores.comerciales
{
	...
	public class EventoCatProOferta extends Event
	{
		...
		public static const OBTENER_CONFIGURACIONES_CLASIFICACION_X_ID_PROVEEDOR:String = "obtenerNivelesDeClasificacionPorIdProveedor";
		public static const OBTENER_TODOS_LOS_PRODUCTOS_DE_PROVEEDOR:String = "obtenerTodosLosProductosDelProveedor";
