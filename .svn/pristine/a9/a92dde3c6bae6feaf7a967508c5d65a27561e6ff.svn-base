package mx.com.proquifa.proquifanet.rsl.vista.modelo.comun.metodos.tree
{
	...
	public class TreeItemRendererCheckBox extends TreeItemRenderer
	{
		public var chk:CheckBox;
		public var itemXml:XML;
		
		public function TreeItemRendererCheckBox(){
			super();
			mouseEnabled = false;
		}
