package mx.com.proquifa.proquifanet.rsl.vista.modelo.comun
{
	...
	[Bindable]
	[RemoteClass(alias="mx.com.proquifa.proquifanet.modelo.comun.CatalogoItem")]
	public class CatalogoItem
	{
		private var _numFila:Number;
		private var _llave:Number;
		private var _valor:String;
		private var _tipoEmpleado:String;// esac, ev
		...
		private var _seleccionado:Boolean = false;
		private var _ultimo:String = "";
		private var _primero:Boolean = false;
		private var _eliminado:Boolean;
		private var _capitular:Boolean = false;
		private var _selected:Boolean;
		
		private var _usoDeCFDI:ArrayCollection;
		private var _metodoPago:ArrayCollection;

		private var _claveUnidad:ArrayCollection;
		private var _claveProdServ:ArrayCollection;
		
		public function CatalogoItem()
		{
		}
		
		public function get capitular():Boolean
		{
			return _capitular;
		}
		
		public function set capitular(value:Boolean):void
		{
			_capitular = value;
		}
		...
		public function get tipoEmpleado():String
		{
			return _tipoEmpleado;
		}
		
		public function set tipoEmpleado(value:String):void
		{
			_tipoEmpleado = value;
		}
		...
		public function get primero():Boolean
		{
			return _primero;
		}
		
		public function set primero(value:Boolean):void
		{
			_primero = value;
		}
		...
		public function get usoDeCFDI():ArrayCollection
		{
			return _usoDeCFDI;
		}

		public function set usoDeCFDI(value:ArrayCollection):void
		{
			_usoDeCFDI = value;
		}

		public function get metodoPago():ArrayCollection
		{
			return _metodoPago;
		}

		public function set metodoPago(value:ArrayCollection):void
		{
			_metodoPago = value;
		}

		public function get claveUnidad():ArrayCollection
		{
			return _claveUnidad;
		}

		public function set claveUnidad(value:ArrayCollection):void
		{
			_claveUnidad = value;
		}

		public function get claveProdServ():ArrayCollection
		{
			return _claveProdServ;
		}

		public function set claveProdServ(value:ArrayCollection):void
		{
		...
		public function set extra(value:String):void
		{
			_extra = value;
		}
