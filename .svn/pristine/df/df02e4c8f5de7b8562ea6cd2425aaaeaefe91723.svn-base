package mx.com.proquifa.proquifanet.rsl.vista.vistas.tableros.clientes.componentes.mixProductos
{
	...
	public class MixProductosMobChart extends PieChartPqGris
	{
		public function MixProductosMobChart()
		{
			super();
			percentWidth = 100;
			percentHeight = 100;
		...
		public function iniciarConsulta( $eventParams:EventoTableroClientes ):void
		{
			...
			var evet:EventoTableroClientes = new EventoTableroClientes(EventoTableroClientes.CONSULTA_LINEAL_MIX_PRODUCTOS );
