package vista.evento
{
	...
	public class EventoEVGestionarVisitas extends Event
	{
		...
		public function EventoEVGestionarVisitas(type:String, bubbles:Boolean=true, cancelable:Boolean=false)
		{
			super(type, bubbles, cancelable);
		}
		
		public override function clone():Event{
			return new EventoEVGestionarVisitas( type, bubbles, cancelable );
		}
	}
}