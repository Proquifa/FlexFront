package mx.com.proquifa.proquifanet.rsl.vista.vistas.tableros.clientes.componentes
{
	...
	public class BarNaranjaRender extends UIComponent implements IDataRenderer
	{
		...
		public function BarNaranjaRender():void
		{
			super();
		}
		...
		{	
			...
			if (label == null)
			{
				...
				fillFondo.entries = [ new GradientEntry(0xD87023), new GradientEntry( 0xD87023 ) ];
