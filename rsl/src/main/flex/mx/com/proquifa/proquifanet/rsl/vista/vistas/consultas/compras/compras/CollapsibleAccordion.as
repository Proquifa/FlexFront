package mx.com.proquifa.proquifanet.rsl.vista.vistas.consultas.compras.compras
{
		...
		override protected function commitProperties():void
		{
			...
			if ( closeChanged )
			{
				...
				if ( _close )  //cierra
				{
					...
					animateProperty.fromValue = openSize; //600
					animateProperty.toValue = barSize; //35
					//openSize = 600;
					//barSize = 35; 
					...
					moveClose.duration = 0; //antes 200
				...
				else //abre
				{
					...
					animateProperty.toValue = openSize; //600
					//openSize = 600;
					//barSize = 35; 
					...
					moveOpen.xTo = 0;
					moveOpen.duration = 0; //200 antes
					moveOpen.addEventListener(EffectEvent.EFFECT_END, onOpenEffectEnd );// antes onOpenEffectEnd
