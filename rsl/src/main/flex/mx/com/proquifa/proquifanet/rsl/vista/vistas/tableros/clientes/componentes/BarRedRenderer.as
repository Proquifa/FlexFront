package mx.com.proquifa.proquifanet.rsl.vista.vistas.tableros.clientes.componentes
{
	...
	public class BarRedRenderer extends UIComponent implements IDataRenderer
	{
		...
		public function BarRedRenderer():void
		{
			super();	        
		}
		...
		{	
			...
			if (label == null){
				...
				fillFondo.entries = [ new GradientEntry(0x990429), new GradientEntry( 0x910824 ) ];
