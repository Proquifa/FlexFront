package mx.com.proquifa.proquifanet.rsl.vista.modelo.compras
{
	...
	public class PartidaCompra  extends Producto
	{
		...
		private var _totalDePiezasRS:int;
		private var _certificadoNoDisponible:Boolean;
		private var _certificadoModificado:Boolean;
	    private var _idPpedido:Number;
		private var _totalStock:Number;
		
		private var _cantidadOriginalCompra:int;
		...
		public function get certificadoModificado():Boolean
		{
			return _certificadoModificado;
		}
		
		public function set certificadoModificado(value:Boolean):void
		{
			_certificadoModificado = value;
		}
		...
		public function get totalDePiezasRS():int
		{
			return _totalDePiezasRS;
		}

		public function set totalDePiezasRS(value:int):void
		{
			_totalDePiezasRS = value;
		}
		...
		public function get familia():String
		{
			...
			if(control == null)
				stringFamilia = tipo +"-"+subtipo+"-"+controlProducto;
			else
		...
		public function get cantidadOriginalCompra():int
		{
			return _cantidadOriginalCompra;
		}

		public function set cantidadOriginalCompra(value:int):void
		{
			_cantidadOriginalCompra = value;
		}
