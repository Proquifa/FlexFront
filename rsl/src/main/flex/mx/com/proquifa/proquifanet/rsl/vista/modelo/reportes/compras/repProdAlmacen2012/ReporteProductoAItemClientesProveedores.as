package mx.com.proquifa.proquifanet.rsl.vista.modelo.reportes.compras.repProdAlmacen2012
{
	...
	public class ReporteProductoAItemClientesProveedores
	{
		...
		private var _restriccionEntrega:Number;
		private var _alertaParciales:Number;
		private var _rutaZona:String;
		...
		public function get restriccionEntrega():Number
		{
			return _restriccionEntrega;
		}

		public function set restriccionEntrega(value:Number):void
		{
			_restriccionEntrega = value;
		}

		public function get alertaParciales():Number
		{
			return _alertaParciales;
		}

		public function set alertaParciales(value:Number):void
		{
			_alertaParciales = value;
		}

		public function get rutaZona():String
		{
			return _rutaZona;
		}

		public function set rutaZona(value:String):void
		{
			_rutaZona = value;
		}
