package mx.com.proquifa.proquifanet.rsl.vista.vistas.tableros.clientes.componentes.ventasDelPeriodo.analisisDeVentas.altos
{
	...
	[Event(name="terminoDeAsignarTamaniosAlosComponentesLayoutAltosEsac", type="flash.events.Event")]
	public class LayoutAltosEsac extends LayoutBase
	{
		public function LayoutAltosEsac()
		{
			super();
		}
		...
		override public function updateDisplayList($containerWidth:Number, $containerHeight:Number):void
		{
			...
			if($containerWidth > 300 )
			{
				...
				dispatchEvent(new Event("terminoDeAsignarTamaniosAlosComponentesLayoutAltosEsac"));
			}
		}
	}
}