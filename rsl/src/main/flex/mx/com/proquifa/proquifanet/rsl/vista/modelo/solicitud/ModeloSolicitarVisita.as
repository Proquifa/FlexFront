package mx.com.proquifa.proquifanet.rsl.vista.modelo.solicitud
{
	...
	import mx.com.proquifa.proquifanet.rsl.vista.modelo.ventas.visita.ResumenSolicitudVisitasyReporteVisita;
	...
	public class ModeloSolicitarVisita extends EventDispatcher
	{
		...
		/**
		 ************************************************************** LISTA INFORMACION VISITAS CLIENTE**************************************************************
		 */ 
		private var _listaInformacion:ResumenSolicitudVisitasyReporteVisita;
		public function setListaInfoVisitasClientes(datos:ResumenSolicitudVisitasyReporteVisita):void{
			
			if(datos !=  null)
				this._listaInformacion = datos;
			else
				_listaInformacion = new ResumenSolicitudVisitasyReporteVisita;
			
			dispatchEvent(new Event ("listaInformacionCliente"));
		}
		
		[Bindable(event="listaInformacionCliente")]
		public function get listaInfoCliente():ResumenSolicitudVisitasyReporteVisita{
			return this._listaInformacion;
		}
