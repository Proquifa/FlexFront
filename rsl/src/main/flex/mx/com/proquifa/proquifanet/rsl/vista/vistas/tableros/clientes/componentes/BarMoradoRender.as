package mx.com.proquifa.proquifanet.rsl.vista.vistas.tableros.clientes.componentes
{
	...
	public class BarMoradoRender extends UIComponent implements IDataRenderer
	{
		...
		public function BarMoradoRender():void
		{
			super();
		}
		...
		{	
			...
			if (label == null)
			{
				...
				fillFondo.entries = [ new GradientEntry(0x692E7F), new GradientEntry( 0x692E7F ) ];
