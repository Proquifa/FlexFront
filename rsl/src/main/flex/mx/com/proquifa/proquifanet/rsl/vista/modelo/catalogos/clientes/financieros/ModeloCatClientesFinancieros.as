package mx.com.proquifa.proquifanet.rsl.vista.modelo.catalogos.clientes.financieros
{
	...
	public class ModeloCatClientesFinancieros extends EventDispatcher
	{
		...
		{
			arrayCFDI = cfdi;
			dispatchEvent(new Event("enviaCFDIModeloCatClientesFinancieros"));
		}
		
		[Bindable(event="enviaCFDIModeloCatClientesFinancieros")]
		...
		{
			arrayMetPago = cfdi;
			dispatchEvent(new Event("enviaMetPagoModeloCatClientesFinancieros"));
		}
		
		[Bindable(event="enviaMetPagoModeloCatClientesFinancieros")]
