package mx.com.proquifa.proquifanet.rsl.vista.eventos.comun
{
	...
	public class EventoBusquedasCR extends Event
	{
		...
		public static const BUSCAR_DOCUMENTOS_POR_FOLIO_TODOS:String = "buscarDocumentosPorFolioTodos";
		public static const BUSCAR_DOCUMENTOS_POR_FOLIO:String = "buscarDocumentoPorFolio";
		public static const BUSCAR_DOCUMENTOS_POR_REF:String = "buscarDocumentosRecibidosPorReferencia";
		...
		public function EventoBusquedasCR(type:String, bubbles:Boolean=true, cancelable:Boolean=false)
		{
		...
		{
			return new EventoBusquedasCR( type, bubbles, cancelable );
		}
	}
	}