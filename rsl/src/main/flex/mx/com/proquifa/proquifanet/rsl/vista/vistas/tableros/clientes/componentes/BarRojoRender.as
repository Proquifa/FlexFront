package mx.com.proquifa.proquifanet.rsl.vista.vistas.tableros.clientes.componentes
{
	...
	public class BarRojoRender extends UIComponent implements IDataRenderer
	{
		...
		public function BarRojoRender():void
		{
			super();
		}
		...
		{	
			...
			if (label == null)
			{
				...
				fillFondo.entries = [ new GradientEntry(0xBF3748), new GradientEntry( 0xBF3748 ) ];
