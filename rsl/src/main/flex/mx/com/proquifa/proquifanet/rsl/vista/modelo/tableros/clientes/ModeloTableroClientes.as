package mx.com.proquifa.proquifanet.rsl.vista.modelo.tableros.clientes
{
	...
	public class ModeloTableroClientes extends EventDispatcher
	{
		...
		//Visita Vs Ventas
		private var _linealVisitasVentasPeriodo:ArrayCollection;
		public function setLinealVisitasVentasPeriodo( $datos:ArrayCollection, $evento:EventoTableroClientes= null):void{
			if($datos == null){
				$datos = new ArrayCollection();
			}
			...
			_linealVisitasVentasPeriodo = $datos;
			dispatchEvent( new Event("regresaLinealVisitasVentasPeriodoModeloTableroCliente") );
			
			if(_linealVisitasVentasPeriodo != null){
				if(actualizarEspera!= null && currentEnEspera){
					setControlDeBloqueoPantalla("terminaEspera",null,null,"regresaLinealVisitasVentasPeriodoModeloTableroCliente");
				}
			}
		}
		[Bindable(event="regresaLinealVisitasVentasPeriodoModeloTableroCliente")]
		public function get listaLinealVisitasVentasPeriodo():ArrayCollection{
			
			return _linealVisitasVentasPeriodo;
		}

		private var _linealVisitasTipo:ArrayCollection;
		public function setLinealVisitasTipo( $datos:ArrayCollection, $evento:EventoTableroClientes= null):void{
			if($datos == null){
				$datos = new ArrayCollection();
			}
			...
			_linealVisitasTipo = $datos;
			dispatchEvent( new Event("regresaLinealVisitasTipoModeloTableroCliente") );
			
			if(_linealVisitasTipo != null){
				if(actualizarEspera!= null && currentEnEspera){
					setControlDeBloqueoPantalla("terminaEspera",null,null,"regresaLinealVisitasTipoModeloTableroCliente");
				}
			}
		}
		[Bindable(event="regresaLinealVisitasTipoModeloTableroCliente")]
		public function get listaLinealVisitasTipo():ArrayCollection{
			
			return _linealVisitasTipo;
		}
		

		private var _resumenVisitasVSVentas:ArrayCollection;
		public function setResumenVisitasVSVentas( $datos:ArrayCollection, $evento:EventoTableroClientes= null):void{
			if($datos == null){
				$datos = new ArrayCollection();
			}
			...
			_resumenVisitasVSVentas = $datos;
			dispatchEvent( new Event("regresaResumenVisitasVsVentasModeloTableroCliente") );
			
			if(_resumenVisitasVSVentas != null){
				if(actualizarEspera!= null && currentEnEspera){
					setControlDeBloqueoPantalla("terminaEspera",null,null,"regresaResumenVisitasVsVentasModeloTableroCliente");
				}
			}
		}
		[Bindable(event="regresaResumenVisitasVsVentasModeloTableroCliente")]
		public function get listaResumenVisitasVsVentas():ArrayCollection{
			
			return _resumenVisitasVSVentas;
		}
		

		private var _resumenVisitasTipo:ArrayCollection;
		public function setResumenVisitasTipo( $datos:ArrayCollection, $evento:EventoTableroClientes= null):void{
			if($datos == null){
				$datos = new ArrayCollection();
			}
			...
			_resumenVisitasTipo = $datos;
			dispatchEvent( new Event("regresaResumenVisitasTipoModeloTableroCliente") );
			
			if(_resumenVisitasTipo != null){
				if(actualizarEspera!= null && currentEnEspera){
					setControlDeBloqueoPantalla("terminaEspera",null,null,"regresaResumenVisitasTipoModeloTableroCliente");
				}
			}
		}
		[Bindable(event="regresaResumenVisitasTipoModeloTableroCliente")]
		public function get listaResumenVisitasTipo():ArrayCollection{
			
			return _resumenVisitasTipo;
		}
		
/*-----------------*/
		private var _detallesVisitasVSVentas:ReportarVisita;
		public function setDetallesVisitasVSVentas( $datos:ReportarVisita, $evento:EventoTableroClientes= null):void{
			
			if($datos == null){
				$datos = new ReportarVisita();
			}
			
			_detallesVisitasVSVentas = $datos;
			dispatchEvent( new Event("regresaDetallesVisitasVsVentasModeloTableroCliente") );
			
			/*if(_detallesVisitasVSVentas != null){
				if(actualizarEspera!= null && currentEnEspera){
					setControlDeBloqueoPantalla("terminaEspera",null,null,"regresaDetallesnVisitasVsVentasModeloTableroCliente");
				}
			}*/
		}
		[Bindable(event="regresaDetallesVisitasVsVentasModeloTableroCliente")]
		public function get listaDetallesVisitasVsVentas():ReportarVisita{
			
			return _detallesVisitasVSVentas;
		}
/*---------------*/
		...
		public function setResibeListaDeResumenVentasClientesTodos($clientes:ArrayCollection):void
		{
			...
			for (var i:int = 0; i < $clientes.length; i++) 
			{
				...
				trace("_conceptoResultado: " + item.conceptoResultado + " etiqueta: '" +item.etiqueta +"' nivelVista: "+ item.nivelIVista);
