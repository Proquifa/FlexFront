package skins.botonesToggle.btnToggleEstados
{
	...
	public class LayoutBotoneraEstrategicos extends LayoutBase
	{
		private static var _instance:LayoutBotoneraEstrategicos = null;
		...
		public function LayoutBotoneraEstrategicos()
		{
			super();
		}
		...
		public static function getInstance():LayoutBotoneraEstrategicos{
			if(_instance ==null)
				_instance = new LayoutBotoneraEstrategicos();
			return _instance;
		}
