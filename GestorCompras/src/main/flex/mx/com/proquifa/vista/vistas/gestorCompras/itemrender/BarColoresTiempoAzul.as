package mx.com.proquifa.vista.vistas.gestorCompras.itemrender
{
	...
	public class BarColoresTiempoAzul extends UIComponent implements IDataRenderer
	{
		...
		public function BarColoresTiempoAzul()
		{
			super();
		}
		...
		{	
			...
			if (label == null)
			{
				...
				rectFondo.filters = [new DropShadowFilter(0, 45, 0x000000, 0)];
		...
		override protected function updateDisplayList(unscaledWidth:Number,unscaledHeight:Number):void
		{
			...
			/*if (csi.item.hasOwnProperty("tipo"))
			{
				...
				switch(csi.item.tipo)
				{
					case "tiempo1":
					{
						fillFondo.entries = [ new GradientEntry(0x0c8995), new GradientEntry( 0x0c8995 ) ];
						break;
					}
					case "tiempo2":
					{
						fillFondo.entries = [ new GradientEntry(0x40a4ad), new GradientEntry( 0x40a4ad ) ];
						break;
					}
					case "tiempo3":
					{
						fillFondo.entries = [ new GradientEntry(0x7abec5), new GradientEntry( 0x7abec5 ) ];
						break;
					}
					case "tiempo4":
					{
						fillFondo.entries = [ new GradientEntry(0xb7d9dd), new GradientEntry( 0xb7d9dd ) ];
						break;
					}
